...
(function() {
    ...
    GapGrid = function() {
        ...
        GapGrid.prototype.getGridPoints = function() {
            var filterByRange, gap, n, result, _i, _len, _ref;
            result = {
            ...
            result.horizontal = function() {
                var _j, _len1, _ref1, _results;
                _ref1 = result.horizontal;
                _results = [];
                for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
                    n = _ref1[_j];
                    _results.push(Math.round(n));
                }
                return _results;
            }();
            result.vertical = function() {
                var _j, _len1, _ref1, _results;
                _ref1 = result.vertical;
                _results = [];
                for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
                    n = _ref1[_j];
                    _results.push(Math.round(n));
